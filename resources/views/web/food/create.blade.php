   ...
   <div class="container py-5">
    ...
    <form action="{{route('product.store')}}"  method="post" class="container" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input name="name" type="text" class="form-control" id="formGroupExampleInput"  placeholder="tên food">
          </div>
          @error('name')
...
<div class="mb-3">
    ...
    <input name="detail" type="text" class="form-control" id="formGroupExampleInput"  placeholder="mo ta">
  </div>
  @error('detail')
<div class="alert alert-danger">{{ $message }}</div>
@enderror
          <div class="mb-3">
            ...
            <input name="produced_on" type="date" class="form-control" id="formGroupExampleInput"  placeholder="produced_on">
          </div>
          @error('produced_on')
    <div class="alert alert-danger">{{ $message }}</div>
@enderror
